...
function BookReader() {
    ...
    //FTS variables
    $fts_dialog = null;
    first_dialog = true; //sets global variable to check if the box has been made
    this.fts_displayed = false;
    ...
    //mobile and responsive menus status
...
BookReader.prototype.initEmbedNavbar = function() {
    ...
    $('#BookReader').append(
        ...
        +         '<button class="BRicon book_left"></button>'
        +         '<button class="BRicon book_right"></button>'
        +         '<a id="show_OCR" onclick="return false" href="#">Show OCR text</a>'
        +         '<a id="hide_OCR" href="#" onclick="return false">Hide OCR text</a>'
        +   "</span>"
