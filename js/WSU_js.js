...
function speakPagealoud(source) {
    ...
    //if not playing, start
        ...
        function speakText(){
            ...
            //solr query for text
            var squery = 'http://fedora.lib.wayne.edu:8080/solr4/bookreader/select/?q=page_num:['+$current_layout.rootpage+' TO '+$current_layout.secondarypage+' ]&fq=ItemID:'+br.ItemID+'&wt=json&json.wrf=callback';        
